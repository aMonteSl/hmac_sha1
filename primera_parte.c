...
void xor_with_ipad(char *key) {
    char ipad[KEY_SIZE + 1];
    memset(ipad, 0x36, sizeof(ipad)); // Llena el array con 0x36
...
int main(int argc, char *argv[]) {
    ...
    // Realizar la operación XOR con la constante ipad
    printf("Realizando operación XOR con la constante ipad...\n");
    xor_with_ipad(key);
